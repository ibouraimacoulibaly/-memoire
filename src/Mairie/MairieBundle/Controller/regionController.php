...
class regionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('MairieMairieBundle:region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('Mairie\MairieBundle\Form\regionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('Mairie\MairieBundle\Form\regionType', $region);
