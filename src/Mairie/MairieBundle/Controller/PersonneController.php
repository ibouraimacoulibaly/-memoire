...
use Mairie\MairieBundle\Entity\Personne;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('MairieMairieBundle:Personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Mairie\MairieBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('Mairie\MairieBundle\Form\PersonneType', $personne);
